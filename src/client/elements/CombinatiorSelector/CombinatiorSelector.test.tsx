...
describe("CombinatorSelector", () => {
  it("renders correctly with initial value", () => {
    render(
      <CombinatorSelector combinator={Combinator.AND} onChange={() => {}} />
    );
  ...
  it("calls onChange with the correct value when changed to OR", () => {
    ...
    render(
      <CombinatorSelector combinator={Combinator.AND} onChange={handleChange} />
    );
    const selectElement = screen.getByRole("combobox");
  ...
  it("calls onChange with the correct value when changed to AND", () => {
    const handleChange = vi.fn();
    render(
      <CombinatorSelector combinator={Combinator.OR} onChange={handleChange} />
    );
    const selectElement = screen.getByRole("combobox");
